...
<div class="block full">
	...
	<div class="block-title">
		<h2><i class="hi hi-cog"></i> <strong>Standing Order - Berdasarkan Pelanggan</strong></h2>
	</div>
				...
				<table id="table_so" class="display table table-vcenter table-condensed table-bordered table-hover" cellspacing="0" width="100%">
					<thead>
						<tr class="themed-color themed-background">
							...
							<th class="text-center text-light" style="width: 20%;">KODE PELANGGAN</th>
							<th class="text-center text-light">NAMA PELANGGAN</th>
							<th class="text-center text-light">NAMA LEMBAGA</th>
							<th class="text-center text-light">ALAMAT LEMBAGA</th>
...
<script type="text/javascript">
	...
	$(document).ready(function() {
        ...
        $('#table_so').dataTable( {
            ...
            "ajax": {
                url: "<?php echo site_url('admin/standing_order/ajax_pelanggan') ?>",
                data: {
	...
	function print(id_pelanggan, id_pesanan_m, id_lembaga) {
        $("<iframe>")                             // create a new iframe element
            .hide()                               // make it invisible
            .attr("src", "<?php echo base_url(); ?>admin/standing_order/print_so_pelanggan/"+id_pelanggan+"/"+id_pesanan_m+"/"+id_lembaga+"") // point the iframe to the page you want to print
