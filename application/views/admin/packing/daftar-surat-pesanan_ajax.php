    ...
    <div class="row">
        <div class='col-sm-4' style="margin-bottom: 5px;">
            <div class="btn-group btn-group-lg">
                <?php echo form_open('admin/packing/surat_pesanan', array('class' => '"', 'id' => '', 'target' => '_blank')); ?>
        ...
        <div class='col-sm-8'>
            ...
            <ul class="fa-ul list-li-push">
                <li><i class="fa fa-li fa-truck text-success"></i> Klik untuk melihat daftar delivery order &nbsp;&nbsp;
                    <i class="fa fa-file-pdf-o text-warning"></i> Cetak Form keluar Barang &nbsp;&nbsp;
                    <i class="gi gi-package text-info"></i> Form keluar Barang
                </li>
            </ul>
        </div>
                ...
                <table id="table_pesanan" class="display table table-vcenter table-condensed table-bordered table-hover" cellspacing="0" width="100%">
                    <thead>
                        <tr class="themed-color themed-background" style="font-weight: bold;">
                            ...
                            <td class="text-light" style="width: 10%;">TOTAL SP</td>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        table = $('#table_pesanan').DataTable({
            ...
            "ajax": {
                url: "<?php echo site_url('admin/packing/ajax_list_pesanan') ?>",
                data: {
