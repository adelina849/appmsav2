...
<script type="text/javascript">
    ...
    function print(id_penerimaan_m) {
        $("<iframe>")                             // create a new iframe element
            .hide()                               // make it invisible
            .attr("src", "<?php echo base_url(); ?>admin/penerimaan/print_surat_penerimaan/"+id_penerimaan_m+"") // point the iframe to the page you want to print
            .appendTo("body");                    
    }       
