...
<div class="block full">
    ...
    <form action="#" method="post" class="form-horizontal form-bordered" onsubmit="return false;">
        ...
        <div class="form-group">
            ...
            <div class="col-md-3 text-info">
                <label for="mitra"><i class="fa fa-users"></i> Nama Penjual</label>
    ...
    <div style="width: 1150px; overflow: hidden; overflow-x: auto; ">
        ...
        <div class="" style="margin-top:15px; width: 1900px;">
...
<script>
    ...
    $(document).on('keyup', '#diskon_barang', function() {
        ...
        $('#TabelTransaksi tbody tr:eq(' + Indexnya + ') td:nth-child(14) input').val(HargaSetelahDiskon.toFixed(0));
        $('#TabelTransaksi tbody tr:eq(' + Indexnya + ') td:nth-child(14) span').html(to_rupiah(HargaSetelahDiskon));

        $('#TabelTransaksi tbody tr:eq(' + Indexnya + ') td:nth-child(13) span input').val(nominalDiskon.toFixed(0));
