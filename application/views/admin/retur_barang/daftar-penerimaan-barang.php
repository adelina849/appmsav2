...
<div class="block full">
    ...
    <div class="row">
        ...
        <div class='col-sm-10'>
            <p class="text-muted">
                Klik menu <i class="fa fa-retweet fa-fw animation-pulse text-info"></i> 
               <strong> pada daftar penerimaan barang</strong>, untuk retur pembelian.              
            </p>
        </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#do').dataTable( {
            ...
            "ajax": {
                url: "<?php echo site_url('admin/retur_barang/all_penerimaan') ?>",
                data: {
