	...
	<div class="row">
		<div class='col-sm-4' style="margin-bottom: 5px;">
			<div class="btn-group btn-group-lg">
				<?php echo form_open('admin/retur_barang/retur_pembelian', array('class' => '"', 'id' => '')); ?>
				...
				<a href="<?= site_url('admin/retur_barang/daftar_penerimaan'); ?>" data-toggle="tooltip" title="Input Retur Barang" class="btn btn-alt btn-sm btn-primary">
					<i class="fa fa-list-alt"></i> Daftar Penerimaan Barang
				</a>
				<?php echo form_close(); ?>
			</div>
		</div>
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$('#retur').dataTable({
			...
			"ajax": {
				url: "<?php echo site_url('admin/retur_barang/all_retur_pembelian') ?>",
				data: {
	...
	function print(retur_pembelian_id) {
		$("<iframe>") // create a new iframe element
			.hide() // make it invisible
			.attr("src", "<?php echo base_url(); ?>admin/retur_barang/print_retur_pembelian/" + retur_pembelian_id + "") // point the iframe to the page you want to print
