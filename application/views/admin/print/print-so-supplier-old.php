            ...
            <div class='col-lg-12' style="margin-bottom: 5px;">
                <table id="" class="table table-vcenter table-condensed table-bordered">
                    ...
                    <?php
                        ...
                        //         packing_detail.* , 
                        //         SUM(packing_detail.qty_so) AS total_so_barang,
                        //         vendor.id,
                        //         barang.kode_barang AS kode_barang,
                        //         barang.nama_barang AS nama_barang,
                        //         barang.spesifikasi AS spesifikasi,
                        //         barang.satuan AS satuan
                        //         FROM packing_detail, barang, vendor
                        //         WHERE packing_detail.id_barang=barang.id_barang
                        //         AND barang.id_vendor=vendor.id
                        //         AND vendor.id='".$id_vendor."'
                        //         AND packing_detail.qty_so > 0
                        //         GROUP BY packing_detail.id_barang");
                        ...
                        ?>
                            <tr>
                                ...
                                <td class="text-center"><?= $pd->total_so_barang; ?></td>
                                <td></td>
                            </tr>
                        <?php
