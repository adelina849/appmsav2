<div class="block full">
	...
	<div class="block-title">
		...
		<h2><i class="hi hi-cog"></i> <strong>DATA MASTER KATEGORI</strong>
		</h2>
	</div>
							...
							<tr>
								...
								<td class="text-center">
									<div class="btn-group btn-group-xs">
										<a href="#" data_id="<?= $d->id; ?>" data_kategori="<?= $d->kategori ?>" data-toggle="tooltip" title="Edit" class="btn btn-xs btn-default edit" onclick="$('#FormEdit').modal('show');">
	...
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			...
			<div class="modal-header text-center">
				<h2 class="modal-title"><i class="fa fa-plus-circle"></i> Data Kategori Baru</h2>
			</div>
			<!-- END Modal Header -->
			<!-- Modal Body -->
			<div class="modal-body">
				...
				<fieldset>
					...
					<div class="form-group">
						<label class="col-md-3 control-label" for="kategori">Nama Kategori <span class="text-danger">*</span></label>
						<div class="col-md-9">
							<div class="input-group">
								<input type="text" id="kategori" name="kategori" class="form-control" placeholder=".." required>
...
<div class="modal fade" id="FormEdit" tabindex="-1" role="dialog" aria-labelledby="modal-fadein" aria-hidden="true">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<!-- Modal Header -->
			<div class="modal-header text-center">
				<h2 class="modal-title"><i class="fa fa-pencil"></i> Edit Kategori</h2>
			</div>
			<!-- END Modal Header -->
			<!-- Modal Body -->
			<div class="modal-body">
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-header">
				<h2 class="modal-title text-center"><i class="gi gi-bin"></i> Hapus Kategori</h2>
			</div>
			<!-- END Modal Header -->
...
<script>
	$(".edit").on('click', function() {
		...
		kategori = $(this).attr("data_kategori");

		$.ajax({
			url: "<?php echo base_url() . 'admin/master/kategori/form_edit'; ?>",
			type: "POST",
