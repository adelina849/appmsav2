<div class="block full">
	...
	<div class="block-title">
		...
		<h2><i class="hi hi-cog"></i> <strong>DATA LOKASI GUDANG</strong>
		</h2>
	</div>
					...
					<tbody>
						...
						?>
							<tr>
								...
								<td><?= $d->kode; ?></td>
								<td><?= strtoupper($d->gudang); ?></td>
								<td class="text-center">
									<div class="btn-group btn-group-xs">
										<a href="#" data_id="<?= $d->id; ?>" data_gudang="<?= strtoupper($d->gudang) ?>" data-toggle="tooltip" title="Edit" class="btn btn-xs btn-default edit" onclick="$('#FormEdit').modal('show');">
											<i class="fa fa-pencil"></i>
										</a>
										<a href="#" data_id="<?= $d->id; ?>" data-toggle="tooltip" title="Hapus" class="btn btn-xs btn-danger hapus" onclick="$('#FormHapus').modal('show');">
	...
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			...
			<div class="modal-header text-center">
				<h2 class="modal-title"><i class="fa fa-university"></i> Tambah Lokasi Gudang Baru</h2>
			</div>
			<!-- END Modal Header -->
			<!-- Modal Body -->
			<div class="modal-body">
				...
				<fieldset>
					...
					<div class="form-group">
						<label class="col-md-3 control-label" for="kode">Kode Gudang<span class="text-danger">*</span></label>
						<div class="col-md-9">
							<div class="input-group">
								<input type="text" id="kode" name="kode" value="<?= $generate_kode; ?>" class="form-control" placeholder=".." readonly required>
								<span class="input-group-addon"><i class="fa fa-pencil-square-o"></i></span>
							</div>
						</div>
					</div>
					<div class="form-group">
						<label class="col-md-3 control-label" for="gudang">Lokasi Gudang <span class="text-danger">*</span></label>
						<div class="col-md-9">
							<div class="input-group">
								<input type="text" id="gudang" name="gudang" class="form-control" placeholder=".." required>
								<span class="input-group-addon"><i class="fa fa-pencil-square-o"></i></span>
							</div>
						</div>
					</div>
...
<div class="modal fade" id="FormEdit" tabindex="-1" role="dialog" aria-labelledby="modal-fadein" aria-hidden="true">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<!-- Modal Header -->
			<div class="modal-header text-center">
				<h2 class="modal-title"><i class="fa fa-pencil"></i> Edit Gudang</h2>
			</div>
			<!-- END Modal Header -->
			<!-- Modal Body -->
			<div class="modal-body">
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-header">
				<h2 class="modal-title text-center"><i class="gi gi-bin"></i> Hapus Gudang</h2>
			</div>
			<!-- END Modal Header -->
...
<script>
	$(".edit").on('click', function() {
		...
		gudang = $(this).attr("data_gudang");

		$.ajax({
			url: "<?php echo base_url() . 'admin/master/gudang/form_edit'; ?>",
			type: "POST",
			data: "id=" + id + "&gudang=" + gudang,
