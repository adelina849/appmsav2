<div class="block full">
	...
	<div class="block-title">
		...
		<h2><i class="hi hi-cog"></i> <strong>DATA MASTER SUMBER DANA</strong>
		</h2>
	</div>
					...
					<tbody>
						...
						?>
							<tr>
								...
								<td><?= strtoupper($d->sumber_dana); ?></td>
								<td><?= $d->keterangan; ?></td>
	...
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			...
			<div class="modal-header text-center">
				<h2 class="modal-title"><i class="fa fa-bitcoin"></i> Sumber Dana</h2>
			</div>
			<!-- END Modal Header -->
			<!-- Modal Body -->
			<div class="modal-body">
				...
				<fieldset>
					...
					<div class="form-group">
                        <label class="col-md-4 control-label" for="sumber_dana">Sumber Dana <span class="text-danger">*</span></label>
                        <div class="col-md-4">
							<input type="text" name="sumber_dana" class="form-control" placeholder="" required>
                        </div>
                    </div>
...
<div class="modal fade" id="FormEdit" tabindex="-1" role="dialog" aria-labelledby="modal-fadein" aria-hidden="true">
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			<!-- Modal Header -->
			<div class="modal-header text-center">
				<h2 class="modal-title"><i class="fa fa-pencil"></i> Edit Sumber Dana</h2>
			</div>
			<!-- END Modal Header -->
			<!-- Modal Body -->
			<div class="modal-body">
...
<script>
	...
	function detail_dana(id) {
        ...
        $.ajax({
            url: "<?php echo site_url('admin/master/sumber_dana/ajax_get_sumberdana') ?>",
            type: "POST",
            data: 'id=' + id,
            dataType: "json",
