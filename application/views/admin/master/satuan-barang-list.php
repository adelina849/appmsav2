<div class="block full">
	...
	<div class="block-title">
		...
		<h2><i class="hi hi-cog"></i> <strong>DATA MASTER SATUAN BARANG</strong>
		</h2>
	</div>
							...
							<tr>
								...
								<td class="text-center">
									<div class="btn-group btn-group-xs">
										<a href="#" data_id="<?= $d->id; ?>" data_satuan='<?= strtoupper($d->satuan); ?>' data-toggle="tooltip" title="Edit" class="btn btn-xs btn-default edit" onclick="$('#FormEdit').modal('show');">
											<i class="fa fa-pencil"></i>
										</a>
										<a href="#" data_id="<?= $d->id; ?>" data-toggle="tooltip" title="Hapus Satuan" class="btn btn-xs btn-danger hapus" onclick="$('#FormHapus').modal('show');">
	...
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			...
			<div class="modal-header text-center">
				<h2 class="modal-title"><i class="fa fa-plus-circle"></i> Tambah Satuan Baru</h2>
			</div>
			<!-- END Modal Header -->
			<!-- Modal Body -->
					...
					<div class="form-group">
						...
						<div class="col-md-9">
							<div class="input-group">
								<input type="text" id="satuan" name="satuan" class="form-control" placeholder=".." required>
...
<div class="modal fade" id="FormEdit" tabindex="-1" role="dialog" aria-labelledby="modal-fadein" aria-hidden="true">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<!-- Modal Header -->
			<div class="modal-header text-center">
				<h2 class="modal-title"><i class="fa fa-pencil"></i> Edit Satuan</h2>
			</div>
			<!-- END Modal Header -->
			<!-- Modal Body -->
			<div class="modal-body">
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-header">
				<h2 class="modal-title text-center"><i class="gi gi-bin"></i> Hapus Satuan</h2>
			</div>
			<!-- END Modal Header -->
...
<script>
	$(".edit").on('click', function() {
		...
		satuan = $(this).attr("data_satuan");

		//$(".id_barang").val(id_barang); //harus ada minimal id

		$.ajax({
			url: "<?php echo base_url() . 'admin/master/satuan/form_edit'; ?>",
			type: "POST",
