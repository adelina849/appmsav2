...
class Pembelian extends Auth_Controller
{
            ...
            $row[] = array(
                ...
                'aksi'=>'<div class="text-center">
                            <div class="btn-group-vertical btn-group-sm">
								<a href="' . site_url('admin/pembelian/detail_pembelian/' . $data->id_pembelian_m. '/barang') . '" data-toggle="tooltip" title="detail barang yang diterima" 
									class="btn btn-alt btn-default btn-xs">
									<i class="fa fa-eye"></i> 
								</a>
								<button onclick="print('.$data->id_pembelian_m.')" 
									class="btn btn-alt btn-default btn-xs" data-toggle="tooltip" title="Cetak Surat Pembelian">
	...
	public function detail_pembelian($id_pembelian){
		$pembelian = $this->db->get_where('pembelian_master', array('id_pembelian_m' => $id_pembelian))->result();

		$data['view']        	= 'admin/pembelian/detail-pembelian';
